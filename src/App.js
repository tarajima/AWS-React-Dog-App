...
import Dogs from './components/DogPages/Dogs';
import DogDetails from './components/DogPages/DogDetails';
        ...
        <Router>
          <div>
            ...
            <Switch>
              ...
              <Route exact path="/dogs" render={(props) => <Dogs {...props} auth={authProps} />} />
              <Route exact path="/dogdetails/:id" render={(props) => <DogDetails {...props} auth={authProps} />} />
